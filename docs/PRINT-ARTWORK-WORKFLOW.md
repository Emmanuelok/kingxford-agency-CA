...
The live review imported a two-page PDF into 250 soft-touch, two-sided cards and verified that one Undo removed both imported faces, with Redo restoring them and the correct selected face. The downloaded proof contained two exact 89 × 51 mm pages with matching trim boxes. The photographic PNG was 1536 × 1024 pixels. All three photographic scenes were visually inspected with composed artwork.

Image Fill, crop, replacement and Undo retained the 457 × 610 mm poster frame, original source pixels and saved-draft recovery. A 390 px phone container had no horizontal page overflow; the PDF page selector and fixed action footer remained usable. A 768 px tablet workspace also had no horizontal overflow. The review identified and corrected the crop button contrast and reduced the phone crop preview height while keeping its action footer accessible.
